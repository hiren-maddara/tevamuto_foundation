...
<template>
    <section class="px-5 py-10 text-gray-800 dark:bg-gray-800 dark:text-gray-100">
		<div class="container grid grid-cols-12 mx-auto gap-y-6  gap-x-8">
			<div class="relative flex col-span-12 dark:bg-gray-500 lg:col-span-9 min-h-96" style="background-image: url('@/assets/img/img-2.jpg');">
				<article class="py-18 mx-auto space-y-16 text-gray-800 dark:bg-gray-800 dark:text-gray-50">
					<div class="w-full mx-auto space-y-4">
						<h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1 uppercase">Health</h2>
					
						<h1 class="text-5xl font-bold leadi">Interdum et malesuada fames ac ante ipsum primis in faucibus?</h1>
						...
						<img src="@/assets/img/img-3.jpg" class="block w-[80%] mx-auto aspect-square max-h-60" alt="">
					</div>
					...
					<div class="container mx-auto px-4 dark:text-gray-100">
						<div class="flex flex-wrap items-center mt-16">
							...
							<div class="w-full md:w-4/12 px-4 mx-auto relative flex flex-col min-w-0 break-words mb-2 shadow-lg rounded-lg bg-pink-500">
			...
			<div class="py-2 col-span-12 xl:col-span-3 lg:col-span-4 lg:block">
				...
				<div class="flex flex-col divide-y divide-gray-700">
					<div class="flex px-1 py-4">
						<img alt="" class="flex-shrink-0 object-cover w-20 h-20 mr-4 dark:bg-gray-500" src="@/assets/img/img-2.jpg">
